        ...
        WInput(
          ...
          */
          slots: WInputSlot(
            ...
            // ),
            null,
            append: const Icon(Icons.arrow_drop_down_rounded),
          ),
        ),
      ],
    );
    ...
    return ListView(
      children: [
        Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          disable,
          paddingWrapper(
              const Text('可清空'), const EdgeInsets.fromLTRB(0, 10, 0, 10), true),
          clearable,
          paddingWrapper(
              const Text('密码框'), const EdgeInsets.fromLTRB(0, 10, 0, 10), true),
          password,
          paddingWrapper(const Text('带 icon 的输入框'),
              const EdgeInsets.fromLTRB(0, 10, 0, 10), true),
          icon,
          paddingWrapper(
              const Text('文本域'), const EdgeInsets.fromLTRB(0, 10, 0, 10), true),
          textarea,
          ...
          size,
          paddingWrapper(const Text('带输入建议'),
              const EdgeInsets.fromLTRB(0, 10, 0, 10), true),
          autocomplete,
          paddingWrapper(const Text('自定义模板'),
              const EdgeInsets.fromLTRB(0, 10, 0, 10), true),
          customTpl,
          paddingWrapper(const Text('远程搜索'),
              const EdgeInsets.fromLTRB(0, 10, 0, 10), true),
          searchRemote,
